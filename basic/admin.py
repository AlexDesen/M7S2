...
def marcar_como_lido(modeladmin, request, queryset):
    queryset.update(lido=True)# Consulta no modelo em questão, filtrado pelo resgistro selecionado.
    modeladmin.message_user(request,'Fomulário de reserva marcada(as) com lida(as)', messages.SUCCESS)  
